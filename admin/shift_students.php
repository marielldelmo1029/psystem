...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_GET['delid'])) {
        ...
        echo "<script>window.location.href = 'shift_students.php'</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Student Management System | Shifted Students</title>
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex align-items-center mb-4">
                                <h4 class="card-title mb-sm-0">Shifted Students</h4>
                            ...
                            <div class="table-responsive border rounded p-1">
                                <table class="table table-hover" id="studentTable">
                                    ...
                                    <tbody>
                                        ...
                                        $ret = "SELECT COUNT(*) as total FROM tblstudent WHERE StudentStatus = 'shift'";
                                        ...
                                        $sql = "SELECT tblstudent.StuID, tblstudent.ID as sid, tblstudent.StudentName, 
                                                ...
                                                WHERE tblstudent.StudentStatus = 'shift' 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!-- View Student button -->
                                                        ...
                                                        <a href="shift_students.php?delid=<?php echo ($row->sid); ?>"
    ...
    <script>
        function printList() {
            ...
            printWindow.document.write('<h3>Complete Student List</h3>');
