...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_GET['delid'])) {
        ...
        echo "<script>window.location.href = 'irregular_students.php'</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Student Management System | Irregular Students</title>
    ...
    <style>
        ...
        @media print {
            /* Hide the header, sidebar, footer, and action buttons during print */
            .main-panel, .sidebar, .footer, .action-column, .btn, .pagination {
                display: none;
            }
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex align-items-center mb-4">
                                <h4 class="card-title mb-sm-0">Irregular Students</h4>
                                <!-- Print Button -->
                                <button class="btn btn-primary ml-auto" onclick="printPage()">Print</button>
                            </div>
                            ...
                            <div class="table-responsive border rounded p-1">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        $ret = "SELECT COUNT(*) as total FROM tblstudent WHERE StudentStatus = 'irregular'";
                                        ...
                                        $sql = "SELECT tblstudent.StuID, tblstudent.ID as sid, tblstudent.StudentName, 
                                                ...
                                                WHERE tblstudent.StudentStatus = 'irregular' 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <!-- View Student button -->
                                                        ...
                                                        <a href="irregular_students.php?delid=<?php echo ($row->sid); ?>"
    ...
    <script>
        function printPage() {
            ...
            printWindow.document.write('<html><head><title>Irregular Students</title>');
            printWindow.document.write('<link rel="stylesheet" href="css/bootstrap.min.css">');
            printWindow.document.write('</head><body>');
            printWindow.document.write('<h2>Irregular Students</h2>');
