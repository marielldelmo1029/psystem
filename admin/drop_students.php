...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_GET['delid'])) {
        ...
        echo "<script>window.location.href = 'drop_students.php'</script>";
    }
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Student Management System | Dropped Students</title>
    ...
    <style>
        ...
        /* Print styles */
        @media print {
            /* Hide irrelevant elements during printing */
            .main-panel, .sidebar, .footer, .action-column, .btn, .pagination, .d-sm-flex {
                display: none;
            }
...
<body>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-sm-flex align-items-center mb-4">
                                <h4 class="card-title mb-sm-0">Dropped Students</h4>
                                <!-- Print Button -->
                                <button class="btn btn-print ml-auto" onclick="printPage()">Print List</button>
                            </div>
                            ...
                            <div class="table-responsive border rounded p-1">
                                <table class="table table-hover">
                                    ...
                                    <tbody class="print-content">
                                        ...
                                        $ret = "SELECT COUNT(*) as total FROM tblstudent WHERE StudentStatus = 'Drop'";
                                        ...
                                        $sql = "SELECT tblstudent.StuID, tblstudent.ID as sid, tblstudent.StudentName, 
                                                    ...
                                                    tblclass.ClassName, tblclass.Section, tblstudent.StudentStatus 
                                                FROM tblstudent 
                                                JOIN tblclass ON tblclass.ID = tblstudent.StudentClass 
                                                WHERE tblstudent.StudentStatus = 'Drop' 
                                            ...
                                            foreach ($results as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td class="action-column">
                                                       ...
                                                       <a href="drop_students.php?delid=<?php echo ($row->sid); ?>"
    ...
    <script>
        function printPage() {
            ...
            printWindow.document.write('<html><head><title>Dropped Students</title>');
            printWindow.document.write('<link rel="stylesheet" href="css/bootstrap.min.css">');
            printWindow.document.write('</head><body>');
            printWindow.document.write('<h2>Dropped Students</h2>');
